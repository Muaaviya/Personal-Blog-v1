...
import { Button } from './404PageButton'
        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-16">
            <div className="flex flex-col items-center">
                <div className="relative mb-16">
                    <svg
                        className="absolute -top-16 -left-12 w-35 h-35 pointer-events-none z-20 animate-spin-slow"
                        viewBox="0 0 140 140"
                        ...
                        <div className="relative p-3 shadow-2xl rotate-[4deg] hover:rotate-0 transition-transform duration-300 bg-white">
                            <div className="relative overflow-hidden bg-white">
                                <img
                                    ...
                                    alt={postcardAlt}
                                    className="w-90 h-55 object-cover"
                                />
                            </div>
                        </div>
                ...
                <div className="text-center max-w-2xl">
                    ...
                    <Button className="rounded-lg px-6 py-3 font-sans">
